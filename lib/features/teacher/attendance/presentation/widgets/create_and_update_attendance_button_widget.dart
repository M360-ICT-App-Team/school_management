...
class CreateAndUpdateAttendanceButtonWidget extends StatefulWidget {
  ...
  const CreateAndUpdateAttendanceButtonWidget({super.key, required this.selectedOption, required this.studentListResponseTeacherModel, required this.student});

  @override
  State<CreateAndUpdateAttendanceButtonWidget> createState() => _CreateAndUpdateAttendanceButtonWidgetState();
}

class _CreateAndUpdateAttendanceButtonWidgetState extends State<CreateAndUpdateAttendanceButtonWidget> {
    final List<String> options = ["present", "late", "leave", "absent"];

  @override
  Widget build(BuildContext context) {
    final isSubmittedAttendance = widget.studentListResponseTeacherModel.isSubmitted;
